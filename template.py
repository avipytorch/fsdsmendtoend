...
list_of_files=[
    ...
    f"src/{package_name}/pipelines/prediciton_pipeline.py",
...
for filepath in list_of_files:
    ...
    os.makedirs() will not raise an error, and it will do noting.
    if mydirectory doesn't exist, it will create the dirctory.
    """
